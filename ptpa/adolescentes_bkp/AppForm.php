    ...
    const AppForm = ({ parametros = {} }) => {
        ...
        const handleCheckboxChange = (e) => {
            ...
            setFormData(prevData => ({
                ...
                Numero: checked ? "S/N" : (prevData.Numero === "S/N" ? randomRG(4).toString() : prevData.Numero)
            }));

            console.log('Checkbox alterado:', {
                checked,
                valor: value,
                novoNumero: checked ? "S/N" : (formData.Numero === "S/N" ? randomRG(4).toString() : formData.Numero)
            });
        };
                ...
                <div className="border border-top-0 mb-4 p-4">
                    ...
                    <div className="row">
                        <div className="col-12 col-sm-6">
                            {formData.Complemento || "Complemento"}
                        </div>
                        <div className="col-12 col-sm-6">
            ...
            <>
                        ...
                        <div>
                            <div className="b-3 p-3">
                                <form className="was-validated" onSubmit={(e) => {
                                    ...
                                    <input type="hidden" id="perfil_id" name="perfil_id" value={formData.UF || ""} />
                                    <input type="hidden" id="perfil_id" name="perfil_id" value={formData.DDD || ""} />
                                    <input type="hidden" id="perfil_id" name="perfil_id" value={formData.GIA || ""} />
                                    <input type="hidden" id="perfil_id" name="perfil_id" value={formData.IBGE || ""} />
                                    <input type="hidden" id="perfil_id" name="perfil_id" value={formData.Regiao || ""} />
                                    <input type="hidden" id="perfil_id" name="perfil_id" value={formData.SIAFI || ""} />
                ...
                <form className="was-validated" onSubmit={(e) => {
                    ...
                    <input
                        ...
                        value={formData.DataCadastramento || ''}
                        onChange={handleChange}
                        required
                    />
                </form>
                ...
                {(typeof AppMessageCard !== "undefined" && message !== null) ? (
                    <div>
                        ...
                        {Array.isArray(ListPeriodos) && ListPeriodos.length > 0 && (
                            <small className="d-block mb-2">Períodos disponíveis: {ListPeriodos.length}</small>
                        )}
                        <AppMessageCard
                            parametros={message}
                            modalId="modal_form"
