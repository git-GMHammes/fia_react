...
$parametros_backend = array(
    ...
    'api_post_cadastrar_escolaridade' => 'index.php/fia/ptpa/escolaridade/api/cadastrar',
    'api_post_atualizar_escolaridade' => 'index.php/fia/ptpa/escolaridade/api/atualizar',
);
$parametros_backend['api_get_atualizar_escolaridade'] = ($atualizar_id !== 'erro') ? ('fia/ptpa/escolaridade/api/exibir' . $atualizar_id) : ('fia/ptpa/escolaridade/api/exibir/erro');
// myPrint($parametros_backend, 'src\app\Views\fia\ptpa\escolaridade\AppAtualizar.php');
?>
...
<script type="text/babel">
    const AppAtualizar = () => {
        ...
        parametros.origemForm = 'escolaridade'
