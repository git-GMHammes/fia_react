<script type="text/babel">
    const AppForm = ({ parametros = {} }) => {
        ...
        const api_post_atualizar_programa = parametros.api_post_atualizar_programa || '';
        const api_post_cadastrar_programa = parametros.api_post_cadastrar_programa || '';
        ...
        const submitAllForms = async (filtro) => {
            ...
            if (filtro === `filtro-${origemForm}`) {
                ...
                console.log(`${base_url}${api_post_cadastrar_programa}`);

                response = await fetch(`${base_url}${api_post_cadastrar_programa}`, {
                    method: 'POST',
        ...
        const fetchProgramas = async () => {
            try {
                const response = await fetch(base_url + api_post_atualizar_programa, {
                                    ...
                                    <form className="needs-validation d-flex justify-content-between align-items-center"
                                        ...
                                        <div className="d-flex gap-2">
                                            ...
                                            <a className="btn btn-danger"
                                                href={`${base_url}index.php/fia/ptpa/programa/endpoint/exibir`}
                                                role="button"
                                            >
                                                Voltar
                                            </a>
