...
$parametros_backend = array(
    ...
    'api_get_exibir_perfil' => 'index.php/fia/ptpa/perfil/api/exibir',
    'api_post_filtrar_perfil' => 'index.php/fia/ptpa/perfil/api/filtrar',
...
<script type="text/babel">
    const AppListar = () => {
        ...
        const api_post_filtrar_perfil = parametros.api_post_filtrar_perfil;

        // Base Lista perfil
        const api_get_exibir_perfil = parametros.api_get_exibir_perfil;
        ...
        const [paginacaoPerfis, setPaginacaoPerfis] = React.useState([]);
        ...
        const submitAllForms = async (filtro) => {
            ...
            if (filtro === 'filtro-perfil') {
                // Convertendo os dados do setPost em JSON
                response = await fetch(base_url + api_post_filtrar_perfil, {
                    method: 'POST',
        ...
        const fetchPerfis = async () => {
            try {
                const response = await fetch(base_url + api_get_exibir_perfil);
                const data = await response.json();
                if (data.result && data.result.dbResponse && data.result.dbResponse[0]) {
                    // console.log('Perfis: ', data.result);
                ...
                <div className="container font-sans">
                    ...
                    <div className="container font-sans">
                        <div className="d-flex justify-content-end">
                            ...
                            <div className="ms-2">
                                <a className="btn btn-primary btn" href={`${base_url}index.php/fia/ptpa/perfil/endpoint/cadastrar/`} role="button">
                                    <i className="bi bi-plus"></i>&nbsp;Cadastrar Perfil</a>
                            </div>
                        </div>
                                    ...
                                    <div className="d-flex flex-lg-nowrap flex-wrap w-100" style={{ gap: '0.5rem' }}>
                                        ...
                                        <div className="flex-grow-1" style={{ flexBasis: '100%' }}>
                                            <form onSubmit={(e) => {
                                                ...
                                                <div style={formGroupStyle}>
                                                    <label
                                                        htmlFor="municipios_nome_municipio"
                                                        style={formLabelStyle}
                            ...
                            <table className="table table-striped">
                                ...
                                <tbody>
                                    {isLoading ? (
                                        ...
                                        perfis.map((perfil_value, index_lista_ado) => (
                                            <tr key={index_lista_ado}>
                                                ...
                                                <td>
                                                    <div className="d-flex justify-content-center">
                                                        <a className="btn btn-outline-primary btn-sm" href={`${base_url}index.php/fia/ptpa/perfil/endpoint/atualizar/${perfil_value.id}`} role="button">
