    ...
    const AppNecessitaMediador = (
        ...
        const handleFocus = (event) => {
            ...
            setFormData((prev) => {
                ...
                if (name === "prontuario_necessita_mediador") {
                    updatedFormData.prontuario_necessita_mediador_pts = value === "Y" ? 1 : 0;
                }
            ...
            <div>
                ...
                <div style={formGroupStyle}>
                    ...
                    <div className="row">
                        <div className="col-12 col-sm-6">
                            <div className="form-check">
                                <input
                                    ...
                                    id="prontuario_necessita_mediador1"
                        ...
                        <div className="col-12 col-sm-6">
                            {(formData.prontuario_necessita_mediador === 'Y') && (
                                <div>
                                    <textarea
                                        data-api="form-prontuario"
                                        id="prontuario_tipo_familiar"
                                        name="prontuario_tipo_familiar"
                                        value={formData.prontuario_tipo_familiar || ''}
                                        onChange={handleChange}
