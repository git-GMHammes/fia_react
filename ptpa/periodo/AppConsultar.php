...
$parametros_backend['api_get_atualizar_periodo'] = ($atualizar_id !== 'erro') ? ('index.php/fia/ptpa/periodo/api/exibir' . $atualizar_id) : ('index.php/fia/ptpa/periodo/api/exibir/erro');
// myPrint($parametros_backend, 'src\app\Views\fia\ptpa\periodo\AppConsultar.php');
?>
