        ...
        const submitAllForms = async (filtro, paginacao) => {
            ...
            setTimeout(() => {
                ...
                if (filtro === 'filtro-adolescente') {
                    fetchPostAdolescentes(base_url, api_post_filter_adolescente, paginacao);
                }
            }, 10);
                ...
                <div className="ms-2 me-2">
                    <div className="d-flex justify-content-end p-1">
                        ...
                        <div>
                            ...
                            <form onSubmit={(e) => {
                                e.preventDefault();
                                submitAllForms('filtro-adolescente', `?page=${page}&limit=10`);
                            }}>
                                <input
                                            ...
                                            <form onSubmit={(e) => {
                                                ...
                                                <AppText parametros={parametros} formData={formData} setFormData={setFormData}
                                                    fieldAttributes={{
                                                        ...
                                                        attributePlaceholder: '', // placeholder 
                                                        attributeMinlength: 4, // minlength 
                                                        attributeMaxlength: 40, // maxlength - Telefone: 14, CPF: 14, CEP: 9, Processo Judicial: 20, Processo SEI: 22
                                                        attributePattern: 'Inteiro', // Inteiro, Caracter, Senha
                                                        attributeAutocomplete: 'on', // on, off ]
                                                        attributeRequired: false,
                                                        attributeReadOnly: false,
                                                        attributeDisabled: false,
                                                        attributeMask: 'Certidao', // CPF, Telefone, CEP, , SEI, Processo.
                                                    }}
                                                />
                                            </form>
                                        </div>
                                ...
                                adolescentes && adolescentes.length > 0 ? (
                                    adolescentes.map((adolescente_value, index_lista_ado) => (
                                        <tr key={index_lista_ado}>
                                            ...
                                            <td>
                                                <div className="d-flex justify-content-center">
                                                    {(adolescente_value.CPF !== '') ? (
                                                        <div>{adolescente_value.CPF}</div>
                                                    ) : (
                                                        <div>{adolescente_value.Certidao}</div>
                                                    )}
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div className="d-flex justify-content-center">
                                                    {adolescente_value.Unidade_Nome}
                                                </div>
                                            </td>
                                            <td>
                                                <div className="d-flex justify-content-center">
                    ...
                    {(pagination == 'filter') && (
                        <nav aria-label="Page navigation example">
                            <ul className="pagination">
                                {paginacaoLista.map((paginacao_value, index) => (
                                    <li key={index} className={`page-item ${paginacao_value.active ? 'active' : ''}`}>
                                        {/* FILTRAR PAGINAÇÃO BK */}
                                        <button
                                            type="button"
                                            className="page-link"
                                            onClick={() => submitAllForms('filtro-adolescente', `${paginacao_value.href}&limit=10`)}
                                        >
                                            {paginacao_value.text.trim()}
                                        </button>
                                    </li>
