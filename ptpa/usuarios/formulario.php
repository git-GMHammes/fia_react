...
<div class="app_form_usuario" data-result='<?php echo json_encode($parametros_backend); ?>'></div>

<script type="text/babel">
    const AppFormUsuario = () => {
        // Variáveis recebidas do Backend
        const parametros = JSON.parse(document.querySelector('.app_form_usuario').getAttribute('data-result'));
                ...
                <div className="m-3">
                    <form className="row g-3 needs-validation" noValidate>
                        <div className="col-md-4">
                            ...
                            <input type="text" name="campo" className="form-control" id="validationCustom01" defaultValue="Mark" required />
                        ...
                        <div className="col-md-4">
                            ...
                            <div className="input-group has-validation">
                                ...
                                <input type="text" id="validationCustomUsername" className="form-control" aria-describedby="inputGroupPrepend" required />
    ...
    ReactDOM.render(<AppFormUsuario />, document.querySelector('.app_form_usuario'));
</script>
<?php
$parametros_backend = array();
?>